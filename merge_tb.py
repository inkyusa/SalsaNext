...
def mergeLossLogger(logPath):
    trainLogger = Logger(os.path.join('logs','tb_summary', 'train'))
    validLogger = Logger(os.path.join('logs','tb_summary', 'valid'))
...
if __name__ == "__main__":
    ...
    print(f"Python template with # args={argLength}")    
    if argLength != 2:
    ...
    logPath = './logs/2021-1-21-20:01/tb/events.out.tfevents.1611226552.aclave-sv1-ph'
    mergeLossLogger(logPath)